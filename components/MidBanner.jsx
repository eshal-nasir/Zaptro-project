        ...
        <div className='absolute inset-0 bg-black/60 md:rounded-2xl bg-opacity-50 flex items-center justify-center'>
          <div className='text-center text-white px-4'>
            ...
            <p className='text-lg md:text-xl mb-6'>
              Discover the latest tech innovative with unbeatable prices and free shipping on all order
            </p>
            <button className='bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 md:py-3 md:px-6 rounded-lg transition duration-500'>
              Shop Now
            </button>
          </div>
        </div>
